...
npx wrangler d1 execute pay-jp-hono-ai-sandbox --file ./schema/sql/create-cards.sql --remote -y
npx wrangler d1 execute pay-jp-hono-ai-sandbox --file ./schema/sql/create-charges.sql --remote -y
